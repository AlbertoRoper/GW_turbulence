"""
reading.py is a Python routine that contains functions used to read
the output files of specific numerical runs.
The runs correspond to Pencil Code simulations of gravitational waves
generated by sources in the early universe
(see https://github.com/AlbertoRoper/cosmoGW) for details.
...
def read_ts(dir_data='.', opt=0, debug=False):
    ...
    if opt > 0:
        with open(file) as fp:
            ...
            while line:
                if lrer == 10:
                    print_lrer_warning(aff2[0], HOME)
                    rerun = False
                    lrer = 0
